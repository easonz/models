...
class DataContainer:
    ...
    def __init__(self,
                 data: Union[mindspore.Tensor, np.ndarray],
                 stack: bool = False,
                 padding_value: int = 0,
                 cpu_only: bool = False,
                 pad_dims: int = 2):
    ...
    @property
    def data(self) -> Union[mindspore.Tensor, np.ndarray]:
        return self._data
    ...
    # def dim(self) -> int:
    #     if isinstance(args[0].data, mindspore.Tensor):
    #         return self.data.dim()
    #     elif isinstance(args[0].data, np.ndarray): #zjy
