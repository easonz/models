...
def main():
    ...
    logging.info(f"run at device {args.deviceid}")
    mindspore.set_context(mode=mindspore.GRAPH_MODE, device_target='Ascend', device_id=args.deviceid, jit_syntax_level=mindspore.STRICT)
