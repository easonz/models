...
class BaseDetector(ms.nn.Cell, metaclass=ABCMeta):
    ...
    async def async__test_test(self, img, img_meta, **kwargs):
    ...
    def construct(self, img, img_meta=None, return_loss=True, **kwargs):
        """
        ...
        """
        if img_meta is None and not return_loss:
            return self.forward_mindir(img)
        elif return_loss:
            # return self.forward_mindir(img)
